...
public class ThemeForIdiomFragment extends Fragment {
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btn_backToTheme.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(ThemeForIdiomFragment.this).navigate(R.id.action_themeForIdiomFragment_to_themeOfIdiomsFragment);
            }
        });
        return view;
    }
